...
class TestMemberTransactionsDTO(unittest.TestCase):
    """MemberTransactionsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MemberTransactionsDTO:
        """Test MemberTransactionsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MemberTransactionsDTO`
        """
        model = MemberTransactionsDTO()
        if include_optional:
            return MemberTransactionsDTO(
                count = 1.337,
                transactions = [
                    openapi_client.models.member_transaction_dto.MemberTransactionDTO(
                        id = '', 
                        type = 'deposit', 
                        amount = '', 
                        comment = '', 
    ...
    def testMemberTransactionsDTO(self):
        """Test MemberTransactionsDTO"""
