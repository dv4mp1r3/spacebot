...
class TestSpaceTransactionDTO(unittest.TestCase):
    """SpaceTransactionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpaceTransactionDTO:
        """Test SpaceTransactionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpaceTransactionDTO`
        """
        model = SpaceTransactionDTO()
        if include_optional:
            return SpaceTransactionDTO(
                id = '',
                type = 'deposit',
                amount = '',
                comment = '',
    ...
    def testSpaceTransactionDTO(self):
        """Test SpaceTransactionDTO"""
