...
class MemberTransactionsDTO(BaseModel):
    """
    MemberTransactionsDTO
    """ # noqa: E501
    count: Union[StrictFloat, StrictInt]
    transactions: List[MemberTransactionDTO]
    __properties: ClassVar[List[str]] = ["count", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "transactions": [MemberTransactionDTO.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
