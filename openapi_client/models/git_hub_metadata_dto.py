...
class GitHubMetadataDTO(BaseModel):
    """
    GitHubMetadataDTO
    """ # noqa: E501
    github_id: StrictStr = Field(alias="githubId")
    github_username: StrictStr = Field(alias="githubUsername")
    __properties: ClassVar[List[str]] = ["githubId", "githubUsername"]
