...
class MembershipSubscriptionStatsDTO(BaseModel):
    """
    MembershipSubscriptionStatsDTO
    """ # noqa: E501
    total_active_amount: StrictStr = Field(alias="totalActiveAmount")
    __properties: ClassVar[List[str]] = ["totalActiveAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalActiveAmount": obj.get("totalActiveAmount")
        })
        return _obj
