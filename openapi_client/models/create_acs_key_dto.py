...
class CreateACSKeyDTO(BaseModel):
    """
    CreateACSKeyDTO
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "key", "name", "memberId"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pan', 'uid']):
            raise ValueError("must be one of enum values ('pan', 'uid')")
        return value
