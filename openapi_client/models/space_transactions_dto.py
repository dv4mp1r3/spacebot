...
class SpaceTransactionsDTO(BaseModel):
    """
    SpaceTransactionsDTO
    """ # noqa: E501
    count: Union[StrictFloat, StrictInt]
    transactions: List[SpaceTransactionDTO]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "transactions": [SpaceTransactionDTO.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
